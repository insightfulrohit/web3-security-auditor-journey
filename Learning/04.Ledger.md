...
<img width="1024" height="1536" alt="1 Ledger" src="https://github.com/user-attachments/assets/a0d8a81d-9176-40b6-8a46-5dbee866d786" />
...
### **In sorts**
A ledger in blockchain is the canonical, append-only record of all validated transactions and state changes. The ledger is maintained in a distributed manner across nodes: every full node stores (or can reconstruct) a copy of the blockchain and independently verifies new transactions and blocks according to the network’s consensus rules.
